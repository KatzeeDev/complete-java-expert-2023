package seccion32.composite.ejemplo;

import seccion32.composite.Archivo;
import seccion32.composite.Directorio;
...
public class EjemploCompositeBuscar {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ecncontrado Api Stream: " + encontrado);
